...
params_unchanged=nvimgcodecs.DecodeParams(color_spec=nvimgcodecs.ColorSpec.UNCHANGED)
...
def test_decode_single_tiff_multichannel():
    ...
    params_unchanged=nvimgcodecs.DecodeParams(color_spec=nvimgcodecs.ColorSpec.UNCHANGED, allow_any_depth=True)
