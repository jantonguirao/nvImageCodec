...
#define NVIMGCDCS_LOG_TRACE(...) \
    NVIMGCDCS_M_LOG(             \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_TRACE, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_LOG_DEBUG(...) \
    NVIMGCDCS_M_LOG(             \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_DEBUG, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_M_LOG_INFO(...) \
    NVIMGCDCS_M_LOG(            \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_INFO, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_LOG_WARNING(...)                                                                 \
    NVIMGCDCS_M_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, \
        __VA_ARGS__)
#define NVIMGCDCS_LOG_ERROR(...) \
    NVIMGCDCS_M_LOG(             \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_ERROR, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_LOG_FATAL(...) \
    NVIMGCDCS_M_LOG(             \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_FATAL, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
...
#define NVIMGCDCS_P_LOG_DEBUG(...) \
    NVIMGCDCS_P_LOG(               \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_DEBUG, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_P_LOG_INFO(...) \
    NVIMGCDCS_P_LOG(            \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_INFO, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_P_LOG_WARNING(...)                                                               \
    NVIMGCDCS_P_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, \
        __VA_ARGS__)
...
#define NVIMGCDCS_E_LOG_DEBUG(...) \
    NVIMGCDCS_E_LOG(               \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_DEBUG, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_E_LOG_INFO(...) \
    NVIMGCDCS_E_LOG(              \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_INFO, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_E_LOG_WARNING(...)                                                               \
    NVIMGCDCS_E_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, \
        __VA_ARGS__)
...
#define NVIMGCDCS_D_LOG_DEBUG(...) \
    NVIMGCDCS_D_LOG(               \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_DEBUG, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_D_LOG_INFO(...) \
    NVIMGCDCS_D_LOG(              \
        NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_INFO, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, __VA_ARGS__)
#define NVIMGCDCS_D_LOG_WARNING(...)                                                               \
    NVIMGCDCS_D_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_UKNOWN, \
        __VA_ARGS__)
