...
NVIMGCODEC_HOST_DEV
NVIMGCODEC_FORCEINLINE constexpr auto dot(const vec<N, T> &a, const vec<N, U> &b) {
...
template <typename T, typename U>
NVIMGCODEC_HOST_DEV
NVIMGCODEC_FORCEINLINE constexpr auto cross(const vec<3, T> &a, const vec<3, U> &b) {
...
template <typename T, typename U>
NVIMGCODEC_HOST_DEV
NVIMGCODEC_FORCEINLINE constexpr auto cross(const vec<2, T> &a, const vec<2, U> &b) {
...
#define DEFINE_SHIFT_VEC_BIN_OP(op)                            \
  template <int N, typename T, typename U>                     \
  NVIMGCODEC_HOST_DEV NVIMGCODEC_FORCEINLINE constexpr vec<N, T> operator  \
