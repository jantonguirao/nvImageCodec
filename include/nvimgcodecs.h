...
#define NVIMGCDCS_MAX_NUM_PLANES 32
    ...
    typedef enum
    {
        ...
        NVIMGCDCS_PROCESSING_STATUS_ORIENTATION_UNSUPPORTED = 0b101,
        NVIMGCDCS_PROCESSING_STATUS_ROI_UNSUPPORTED = 0b1001,
        NVIMGCDCS_PROCESSING_STATUS_SAMPLING_UNSUPPORTED = 0b10001,
        NVIMGCDCS_PROCESSING_STATUS_SAMPLE_TYPE_UNSUPPORTED = 0b100001,
        NVIMGCDCS_PROCESSING_STATUS_SAMPLE_FORMAT_UNSUPPORTED = 0b1000001,
        NVIMGCDCS_PROCESSING_STATUS_NUM_PLANES_UNSUPPORTED = 0b10000001,
        NVIMGCDCS_PROCESSING_STATUS_NUM_CHANNELS_UNSUPPORTED = 0b100000001,
