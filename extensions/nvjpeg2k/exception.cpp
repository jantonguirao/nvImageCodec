...
const std::map<nvjpeg2kStatus_t, nvimgcdcsStatus_t> nvjpeg2k_to_nvimgcodecs_error_map = 
    ...
    {NVJPEG2K_STATUS_NOT_INITIALIZED, NVIMGCDCS_STATUS_EXTENSION_NOT_INITIALIZED},
    {NVJPEG2K_STATUS_INVALID_PARAMETER, NVIMGCDCS_STATUS_EXTENSION_INVALID_PARAMETER},
    {NVJPEG2K_STATUS_INTERNAL_ERROR, NVIMGCDCS_STATUS_EXTENSION_INTERNAL_ERROR},    
    {NVJPEG2K_STATUS_IMPLEMENTATION_NOT_SUPPORTED, NVIMGCDCS_STATUS_EXTENSION_IMPLEMENTATION_NOT_SUPPORTED},
    {NVJPEG2K_STATUS_EXECUTION_FAILED, NVIMGCDCS_STATUS_EXTENSION_EXECUTION_FAILED},
    {NVJPEG2K_STATUS_BAD_JPEG, NVIMGCDCS_STATUS_EXTENSION_BAD_CODE_STREAM},    
    {NVJPEG2K_STATUS_ALLOCATOR_FAILURE, NVIMGCDCS_STATUS_EXTENSION_ALLOCATOR_FAILURE},
    {NVJPEG2K_STATUS_JPEG_NOT_SUPPORTED, NVIMGCDCS_STATUS_EXTENSION_CODESTREAM_UNSUPPORTED}};
