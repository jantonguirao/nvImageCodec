...
#define NVIMGCDCS_X_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "nvpnm-extension", msg)
#define NVIMGCDCS_P_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "nvpnm-parser", msg)
#define NVIMGCDCS_E_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "nvpnm-encoder", msg)
#define NVIMGCDCS_D_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "nvpnm-decoder", msg)

#define NVIMGCDCS_LOG_TRACE(...) NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_TRACE, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
#define NVIMGCDCS_LOG_DEBUG(...) NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_DEBUG, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
#define NVIMGCDCS_M_LOG_INFO(...) NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_INFO, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
#define NVIMGCDCS_LOG_WARNING(...) \
    NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
#define NVIMGCDCS_LOG_ERROR(...) NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_ERROR, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
#define NVIMGCDCS_LOG_FATAL(...) NVIMGCDCS_X_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_FATAL, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, __VA_ARGS__)
