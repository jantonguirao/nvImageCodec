...
const std::map<nvjpegStatus_t, nvimgcdcsStatus_t> nvjpeg_status_to_nvimgcodecs_error_map = 
    ...
    {NVJPEG_STATUS_NOT_INITIALIZED, NVIMGCDCS_STATUS_EXTENSION_NOT_INITIALIZED},
    {NVJPEG_STATUS_INVALID_PARAMETER, NVIMGCDCS_STATUS_EXTENSION_INVALID_PARAMETER},
    {NVJPEG_STATUS_INTERNAL_ERROR, NVIMGCDCS_STATUS_EXTENSION_INTERNAL_ERROR},
    {NVJPEG_STATUS_INCOMPLETE_BITSTREAM, NVIMGCDCS_STATUS_EXTENSION_INCOMPLETE_BITSTREAM},
    {NVJPEG_STATUS_IMPLEMENTATION_NOT_SUPPORTED, NVIMGCDCS_STATUS_EXTENSION_IMPLEMENTATION_NOT_SUPPORTED},
    {NVJPEG_STATUS_EXECUTION_FAILED, NVIMGCDCS_STATUS_EXTENSION_EXECUTION_FAILED},
    {NVJPEG_STATUS_BAD_JPEG, NVIMGCDCS_STATUS_EXTENSION_BAD_CODE_STREAM},
    {NVJPEG_STATUS_ARCH_MISMATCH, NVIMGCDCS_STATUS_EXTENSION_ARCH_MISMATCH},
    {NVJPEG_STATUS_ALLOCATOR_FAILURE, NVIMGCDCS_STATUS_EXTENSION_ALLOCATOR_FAILURE},
    {NVJPEG_STATUS_JPEG_NOT_SUPPORTED, NVIMGCDCS_STATUS_EXTENSION_CODESTREAM_UNSUPPORTED}};
...
{    
    if (isCudaStatus_)
        return NVIMGCDCS_STATUS_EXTENSION_CUDA_CALL_ERROR;
    else
    {
