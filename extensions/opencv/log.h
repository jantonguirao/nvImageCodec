...
#define NVIMGCDCS_M_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "opencv-module", 0, msg)
#define NVIMGCDCS_P_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "opencv-parser", 0, msg)
#define NVIMGCDCS_E_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "opencv-encoder", 0, msg)
#define NVIMGCDCS_D_LOG(svr, type, msg) NVIMGCDCS_LOG(svr, type, "opencv-decoder", 0, msg)
...
#define NVIMGCDCS_LOG_WARNING(...)                                                                 \
    NVIMGCDCS_M_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, \
        __VA_ARGS__)
...
#define NVIMGCDCS_P_LOG_WARNING(...)                                                               \
    NVIMGCDCS_P_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, \
        __VA_ARGS__)
...
#define NVIMGCDCS_E_LOG_WARNING(...)                                                               \
    NVIMGCDCS_E_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, \
        __VA_ARGS__)
...
#define NVIMGCDCS_D_LOG_WARNING(...)                                                               \
    NVIMGCDCS_D_LOG(NVIMGCDCS_DEBUG_MESSAGE_SEVERITY_WARNING, NVIMGCDCS_DEBUG_MESSAGE_TYPE_GENERAL, \
        __VA_ARGS__)
