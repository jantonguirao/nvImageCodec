...
# TODO(janton): alternatively, support dlopen nvjpeg via stubs
if(BUILD_NVJPEG_EXT)
    CUDA_find_library(NVJPEG_LIBRARY nvjpeg_static)
    CUDA_find_library(CUDA_culibos_LIBRARY culibos)  # needed when linking with static nvjpeg
    if (${NVJPEG_LIBRARY} STREQUAL "NVJPEG_LIBRARY-NOTFOUND")
        ...
        message(NOTICE "Found culibos: " ${CUDA_culibos_LIBRARY})
        set(NVJPEG_LIBRARY_DEPS ${CUDA_culibos_LIBRARY})
    endif()
else()
    message(WARNING "nvjpeg build disabled")
endif()
